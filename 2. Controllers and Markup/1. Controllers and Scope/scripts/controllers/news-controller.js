app.controller('NewsController', 
	function NewsController($scope) {
		$scope.news = {
			name: 'SoftUni moves near Student city',
			...
			comments: [
				{
					...
					content: 'Every student is welcome to the new SoftUni place',
					date: new Date(2014, 12, 13, 12, 14).toDateString(),
					votes: 0,
				},
				{
					author: 'Vladimir Georgiev',
					content: 'We are very happy to read this article',
				...
				},
				{
					...
					content: 'Hurrah, will no longer travel in 1 hour to work.',
