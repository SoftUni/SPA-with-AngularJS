...
intellisense.annotate(jQuery.fn, {
  ...
  'id': function() {
    /// <signature>
    ///   <summary>Selects a single element with the given postId attribute.</summary>
    ///   <param name="postId" type="String">An ID to search for, specified via the postId attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
